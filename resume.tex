...
Design and develop a proactive and reactive mixed scheduler named \textit{Omar} for the proxy layer in Alibaba Elastic Block Storage. \textit{Omar} can enhance tail latency performance by 60.0\% compared to existing solutions.
